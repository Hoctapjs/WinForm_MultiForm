...
-- biểu đồ 1
SELECT NV.TENNV, COUNT(DH.MANV) AS SoLuongDonHang FROM DONHANG DH JOIN NHANVIEN NV ON DH.MANV = NV.MANV GROUP BY NV.TENNV;    

-- biểu đồ 2
SELECT NV.TENNV, SUM(DH.TONGGIA) AS TongDoanhThu
FROM DONHANG DH
...
-- biểu đồ 4
SELECT TOP 10 MASP, SUM(SOLUONG) AS TongSoLuong
FROM CHITIETDONHANG
GROUP BY MASP
